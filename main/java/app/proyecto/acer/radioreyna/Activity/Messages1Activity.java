...
import app.proyecto.acer.radioreyna.Entities.AdapterMessages;
import app.proyecto.acer.radioreyna.Entities.MensajeEnviar;
import app.proyecto.acer.radioreyna.Entities.MensajeRecibir;
...
public class Messages1Activity extends AppCompatActivity {
        ...
        if(requestCode == PHOTO_SEND && resultCode == RESULT_OK){
            ...
            fotoReferencia.putFile(u).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    databaseReference.push().setValue(m);
                    Glide.with(Messages1Activity.this).load(u.toString()).into(fotoPerfil);
                }
            });
        }
    }
    ...
    private void returnLoguin(){
        startActivity(new Intent(Messages1Activity.this, LoginActivity.class)); //aqui se tenia LoginActivity
        finish();
    }

    @Override
    public void onBackPressed() {
        MainActivity.ACTIVITY_SERVICE.isEmpty();
        super.onBackPressed();
    }
}
